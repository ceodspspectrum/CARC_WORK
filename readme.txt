...
4. For the first time installation, you need to switch your current shell mode to bash.
...
6. Install the deep learning Packages (You can install one 	of these or as per your need.)
...
7. Install additional Machine Learning packages
